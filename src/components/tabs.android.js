...
const Instance = require('./instanceView')
const Logout =  require('./logoutView')
const Alert =  require('./alertView')
      ...
      <TabNavigator>
        ...
        <TabNavigator.Item
          selected={this.state.selectedTab === 'instance'}
            renderIcon={() =><Image source={{uri: iconDashboard}}
       style={{width: 20, height: 20}} />}
        ...
        <TabNavigator.Item
          ...
          renderIcon={() =><Image source={{uri: iconHeroes}}
